...
class Bank{
    ...
    {   System.out.println("----ENTER YOUR NAME----");
        ...
        Bank.acc_no=sc.nextInt();
        if(Bank.acc_no==this.tempacc){
        ...
        System.out.println("ACCOUNT NUMBER    : "+ Bank.acc_no);
        }
        else{
            System.out.println("WRONG ACCOUNT NUMBER");
        }
...
public class que6 {        System.out.println("BALANCE AMOUNT    : "+ this.balance);
